...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            loss_weight=1.0,
            avg_non_ignore=True),
        illumination_channels=256,
        illumination_features_channels=64,
        sampler=dict(type='OHEMPixelSampler', thresh=0.7, min_kept=20000)),
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=384,
        in_index=2,
...
lr_config = dict(
    ...
    min_lr=0.0,
    by_epoch=False)
runner = dict(type='IterBasedRunner', max_iters=26000)
